...
/**
 * Class to store features of a septum :
 *  - length
 *  - width
 *  - angleToMajorAxis : angle relative to major axis
 *  - positionToMajorAxis : position where septum and major axis cross each other
 * 
 * @author marie
 *
 */
public class Septum {
	 ...
	 */
	public Septum (double lenght,
			double width,
			double angleToMajorAxis,
