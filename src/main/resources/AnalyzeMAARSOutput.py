...
def getMitoticElongation(cellRois,calibration,acq_interval,features_dir, cellNb, p, minSegLen, channel, mitosisFigDir, save_plot = True):
...
#     launcher.set_minimumPeriod(200)
    ...
    for cellNb in cellNbs:
        tasks.append( (cellRois, calibration, acq_interval,features_dir, cellNb, -11, minSegLen, channel, mitosisFigDir) )
