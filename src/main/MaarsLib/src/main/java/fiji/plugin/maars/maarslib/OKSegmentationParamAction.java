...
public class OKSegmentationParamAction implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (step != maarsSD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
		...
		if (cellSize != maarsSD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
			...
			maarsSD.getParameters().getParametersAsJsonObject()
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject().remove(AllMaarsParameters.CELL_SIZE);

			maarsSD.getParameters()
					.getParametersAsJsonObject()
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.CELL_SIZE,
							Double.valueOf(cellSize));
		}

		double minCellArea = dialog.getNextNumber();
		if (minCellArea != maarsSD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
			...
			maarsSD.getParameters()
					...
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.MINIMUM_CELL_AREA,
							Double.valueOf(minCellArea));
		}
		...
		if (minCellArea != maarsSD.getParameters().getParametersAsJsonObject()
			...
			maarsSD.getParameters()
					...
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.MAXIMUM_CELL_AREA,
							Double.valueOf(maxCellArea));
		}
		...
		if (filterMeanGrey != maarsSD.getParameters()
			...
			maarsSD.getParameters()
					...
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.FILTER_MEAN_GREY_VALUE,
							Boolean.valueOf(filterMeanGrey));
		}

		double meanGreyVal = dialog.getNextNumber();
		if (meanGreyVal != maarsSD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
			...
			maarsSD.getParameters()
					...
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.MEAN_GREY_VALUE,
							Double.valueOf(meanGreyVal));
		}
		...
		if (filterSolidity != maarsSD.getParameters()
			...
			maarsSD.getParameters()
					...
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.FILTER_SOLIDITY,
							Boolean.valueOf(filterSolidity));
		}

		double solidity = dialog.getNextNumber();
		if (solidity != maarsSD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
			...
			maarsSD.getParameters().getParametersAsJsonObject()
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject().remove(AllMaarsParameters.SOLIDITY);

			maarsSD.getParameters()
					.getParametersAsJsonObject()
					.get(AllMaarsParameters.SEGMENTATION_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.SOLIDITY,
							Double.valueOf(solidity));
		}
