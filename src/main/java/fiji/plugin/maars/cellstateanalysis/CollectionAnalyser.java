 ...
 * @version Nov 14, 2015
 *
 * Class compute features of a collection of spots
 * And put feature computed to the 
 */
public class CollectionAnalyser {
	 ...
	 */
	public CollectionAnalyser(ArrayList<Spot> spotList, Measures measures, Roi cellShapeRoi, Calibration cal,
			Roi roiBeforeCrop) {
