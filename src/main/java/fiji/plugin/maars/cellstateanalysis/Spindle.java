...
public class Spindle {
	...
	// * of image entered where cell boundaries are drawn in pink, major and
	// minor
	...
	//
	// /**
	// * Method to get a schematic representation of the spindle according to
	// the
	// * cell dimensions
	// *
	// * @param width
	...
	// */
	// public ColorProcessor getProcessorReferencedSpindle(int width, int
	// heigth,
