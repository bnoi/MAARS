	...
	public void actionPerformed(ActionEvent e) {
		...
		if (absMinSpindleSizeF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.getAsJsonObject()
					.addProperty(
							AllMaarsParameters.ABSOLUTE_MINIMUM_SPINDLE_SIZE,
							Boolean.valueOf(absMinSpindleSizeF));
		}
		...
		if (absMinSpindleSize != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							AllMaarsParameters.ABSOLUTE_MINIMUM_SPINDLE_SIZE,
							Double.valueOf(absMinSpindleSize));
		}
		...
		if (absMaxSpindleSizeF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							...
							Boolean.valueOf(absMaxSpindleSizeF));
		}
		...
		if (absMaxSpindleSize != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							AllMaarsParameters.ABSOLUTE_MAXIMUM_SPINDLE_SIZE,
							Double.valueOf(absMaxSpindleSize));
		}
		...
		if (relativeAngleSpindleF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.get(AllMaarsParameters.CONDITIONS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.RELATIVE_SPINDLE_ANGLE,
							Boolean.valueOf(relativeAngleSpindleF));
		}
		...
		if (relativeAngleSpindle != maarsMMD.getParameters()
				...
				.getAsJsonObject().get(AllMaarsParameters.VALUES)
				.getAsJsonObject()
				.get(AllMaarsParameters.RELATIVE_SPINDLE_ANGLE).getAsDouble()) {
			...
			maarsMMD.getParameters()
					...
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.RELATIVE_SPINDLE_ANGLE,
							Double.valueOf(relativeAngleSpindle));
		}
		...
		if (maxAbsSpindleSizeF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							AllMaarsParameters.ABSOLUTE_MAXIMUM_SPINDLE_SIZE,
							Boolean.valueOf(maxAbsSpindleSizeF));
		}
		...
		if (maxAbsSpindleSize != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							AllMaarsParameters.ABSOLUTE_MAXIMUM_SPINDLE_SIZE,
							Double.valueOf(maxAbsSpindleSize));
		}
		...
		if (maxRelSpindleSizeF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							...
							Boolean.valueOf(maxRelSpindleSizeF));
		}
		...
		if (maxRelSpindleSize != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.addProperty(
							AllMaarsParameters.RELATIVE_MAXIMUM_SPINDLE_SIZE,
							Double.valueOf(maxRelSpindleSize));
		}
		...
		if (relSpindleAngleF != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.RELATIVE_SPINDLE_ANGLE,
							Boolean.valueOf(relSpindleAngleF));
		}
		...
		if (relSpindleAngle != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.RELATIVE_SPINDLE_ANGLE,
							Double.valueOf(relSpindleAngle));
		}

		boolean timeLimitF = dialog.getNextBoolean();

		if (timeLimitF != maarsMMD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
				.getAsJsonObject().get(AllMaarsParameters.END_MOVIE_CONDITIONS)
				.getAsJsonObject().get(AllMaarsParameters.CONDITIONS)
			...
			maarsMMD.getParameters().getParametersAsJsonObject()
					...
					.get(AllMaarsParameters.END_MOVIE_CONDITIONS)
					.getAsJsonObject().get(AllMaarsParameters.CONDITIONS)
					.getAsJsonObject().remove(AllMaarsParameters.TIME_LIMIT);
			...
			maarsMMD.getParameters()
					...
					.get(AllMaarsParameters.CONDITIONS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.TIME_LIMIT,
							Boolean.valueOf(timeLimitF));
		}

		double timeLimit = dialog.getNextNumber();

		if (timeLimit != maarsMMD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
				.getAsJsonObject().get(AllMaarsParameters.END_MOVIE_CONDITIONS)
				.getAsJsonObject().get(AllMaarsParameters.VALUES)
				.getAsJsonObject().get(AllMaarsParameters.TIME_LIMIT)
			...
			maarsMMD.getParameters()
					...
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.TIME_LIMIT,
							Double.valueOf(timeLimit));
		}

		boolean minGrowingF = dialog.getNextBoolean();

		if (minGrowingF != maarsMMD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
				.getAsJsonObject().get(AllMaarsParameters.END_MOVIE_CONDITIONS)
				.getAsJsonObject().get(AllMaarsParameters.CONDITIONS)
			...
			maarsMMD.getParameters()
					...
					.get(AllMaarsParameters.CONDITIONS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.GROWING_SPINDLE,
							Boolean.valueOf(minGrowingF));
		}

		double minGrowing = dialog.getNextNumber();

		if (minGrowing != maarsMMD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
				.getAsJsonObject().get(AllMaarsParameters.END_MOVIE_CONDITIONS)
				.getAsJsonObject().get(AllMaarsParameters.VALUES)
				.getAsJsonObject().get(AllMaarsParameters.GROWING_SPINDLE)
		...
		if (timeInterval != maarsMMD.getParameters()
			...
			maarsMMD.getParameters().getParametersAsJsonObject()
					.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
					.getAsJsonObject().remove(AllMaarsParameters.TIME_INTERVAL);

			maarsMMD.getParameters()
					.getParametersAsJsonObject()
					.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.TIME_INTERVAL,
							Double.valueOf(timeInterval));
		}

		double range = dialog.getNextNumber();

		if (range != maarsMMD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
			...
			maarsMMD.getParameters()
					...
					.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.RANGE_SIZE_FOR_MOVIE,
		...
		if (range != maarsMMD.getParameters().getParametersAsJsonObject()
			...
			maarsMMD.getParameters().getParametersAsJsonObject()
					.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
					.getAsJsonObject().remove(AllMaarsParameters.STEP);
		...
		if (marginAroundCell != maarsMMD.getParameters()
			...
			maarsMMD.getParameters()
					...
					.get(AllMaarsParameters.MITOSIS_MOVIE_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.MARGIN_AROUD_CELL,
							Double.valueOf(marginAroundCell));
		}
