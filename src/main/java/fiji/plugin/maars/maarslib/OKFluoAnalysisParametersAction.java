...
public class OKFluoAnalysisParametersAction implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (range != maarsFAD.getParameters().getParametersAsJsonObject()
		...
		if (step != maarsFAD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
		...
		if (saveMovies != maarsFAD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
				.getAsJsonObject()
			...
			maarsFAD.getParameters()
					...
					.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.SAVE_FLUORESCENT_MOVIES,
							Boolean.valueOf(saveMovies));
		}

		double spotRadius = dialog.getNextNumber();
		if (spotRadius != maarsFAD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
			...
			maarsFAD.getParameters().getParametersAsJsonObject()
					.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
					.getAsJsonObject().remove(AllMaarsParameters.SPOT_RADIUS);

			maarsFAD.getParameters()
					.getParametersAsJsonObject()
					.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.SPOT_RADIUS,
							Double.valueOf(spotRadius));
		}
		int spotNumber = (int) dialog.getNextNumber();
		if (spotNumber != maarsFAD.getParameters().getParametersAsJsonObject()
				.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
				.getAsJsonObject()
			...
			maarsFAD.getParameters()
					...
					.get(AllMaarsParameters.FLUO_ANALYSIS_PARAMETERS)
					.getAsJsonObject()
					.addProperty(AllMaarsParameters.MAXIMUM_NUMBER_OF_SPOT,
							Integer.valueOf(spotNumber));
		}
